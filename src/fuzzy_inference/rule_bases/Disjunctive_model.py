    ...
    def perform_inference(self, sample, modifier_type = None):
        ...
        while True:
            ...
            for rule_id_i, function_id in enumerate(rule_permutation):
                ...
                if min_val == 0:
                    break
            value_to_append = T_norm(min_val, modifier(self.output_membership_grid,
        ...
        final_quality_membership = np.max(resulting_rule, axis=0)
...
if __name__ == "__main__":
    ...
    dummy_system = MamdaniInferenceSystem(matrix)
